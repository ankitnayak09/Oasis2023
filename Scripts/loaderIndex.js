...
// 		setTimeout(() => {
// 			for (let i = 0; i < 2; i++)
// 				appear[i].style.animation = "fade-in 1.7s";
// 		}, 3000);
...
// 				fblue[i].style.animation =
// 					"fall-blue-2 52s linear 2.4s infinite";
// 				fyellow[i].style.animation =
// 					"fall-yellow-2 52s linear 2.4s infinite";
// 			}
